...
class ProblemFormulator:
    def __init__(self):
        self.templates = [
            {"pattern": r"Who is the father of (\w+)\?", "predicate": "is_father", "args": [lambda m: Var("X"), lambda m: m.group(1).lower()]},
            {"pattern": r"Is (\w+) the father of (\w+)\?", "predicate": "is_father", "args": [lambda m: m.group(1).lower(), lambda m: m.group(2).lower()]},
            {"pattern": r"Who is the mother of (\w+)\?", "predicate": "is_mother", "args": [lambda m: Var("X"), lambda m: m.group(1).lower()]},
            {"pattern": r"Is (\w+) the mother of (\w+)\?", "predicate": "is_mother", "args": [lambda m: m.group(1).lower(), lambda m: m.group(2).lower()]},
            {"pattern": r"Who (are|is) the (children|child) of (\w+)\?", "predicate": "is_child", "args": [lambda m: Var("X"), lambda m: m.group(3).lower()]},
            {"pattern": r"Is (\w+) a child of (\w+)\?", "predicate": "is_child", "args": [lambda m: m.group(1).lower(), lambda m: m.group(2).lower()]},
            {"pattern": r"Who (are|is) the grandparent(s)? of (\w+)\?", "predicate": "is_grandparent", "args": [lambda m: Var("X"), lambda m: m.group(3).lower()]},
            {"pattern": r"Is (\w+) a grandparent of (\w+)\?", "predicate": "is_grandparent", "args": [lambda m: m.group(1).lower(), lambda m: m.group(2).lower()]},
            {"pattern": r"Who (are|is) the sibling(s)? of (\w+)\?", "predicate": "is_sibling", "args": [lambda m: Var("X"), lambda m: m.group(3).lower()]},
            {"pattern": r"Are (\w+) and (\w+) siblings\?", "predicate": "is_sibling", "args": [lambda m: m.group(1).lower(), lambda m: m.group(2).lower()]},
        ]
